...
//
// llama_wukong variant: optimized for NOUGHT hardware (8x K80, sm_37)
// with GPU-accelerated scoring via triattention_gpu_* API.
// UnobligatedRascal
...
enum triattention_mode {
    ...
    // selects independently. Most fine-grained.

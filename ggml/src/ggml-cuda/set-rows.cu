...
static void set_rows_cuda(ggml_backend_cuda_context & ctx, const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ...
    // TurboQuant KV cache types — UnobligatedRascal sm_37 integration
    else if (dst->type == GGML_TYPE_TURBO3_0) {
        turbo_innerq_check_finalize(QK_TURBO3, ne00);
        set_rows_cuda_quant<idx_t, block_turbo3_0, QK_TURBO3, quantize_f32_turbo3_0_block_full>(
        ...
        set_rows_cuda_quant<idx_t, block_turbo4_0, QK_TURBO4, quantize_f32_turbo4_0_block_full>(
        ...
        turbo_innerq_check_finalize(QK_TURBO2, ne00);
        set_rows_cuda_quant<idx_t, block_turbo2_0, QK_TURBO2, quantize_f32_turbo2_0_block_full>(
